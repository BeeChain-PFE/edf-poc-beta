    ...
    <div className="casper-signer-block mb-4 row align-items-center">
      ...
      <div className="col-12 col-md p-0">
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          href="https://chrome.google.com/webstore/detail/casperlabs-signer/djhndpllfiibmcdbnmaaahkhchcoijce?utm_source=chrome-ntp-icon"
        >
          Download signer
        </a>
      </div>
